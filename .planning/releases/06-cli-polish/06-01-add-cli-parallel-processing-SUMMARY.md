...
# Release 5 Change 1: Add CLI Parallel Processing Summary
...
- **No --parallel flag**: Removed from change since --max-concurrency=1 provides sequential mode. A flag that defaults to true is redundant.
...
None - change executed as specified.
...
- Next change: 05-02-benchmarking-suite (JMH benchmarks, concurrency models, tool comparison)
- Verification of 100+ files/sec target deferred to benchmarking release
