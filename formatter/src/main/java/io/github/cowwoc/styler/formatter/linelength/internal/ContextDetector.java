	...
	private WrapContext classifyNode(NodeIndex nodeIndex)
	{
		...
		return switch (type)
		{
			...
			case UNARY_EXPRESSION, POSTFIX_EXPRESSION, ASSIGNMENT_EXPRESSION,
				...
				ARRAY_INITIALIZER, CLASS_LITERAL, RECORD_PATTERN -> WrapContext.NOT_WRAPPABLE;
			...
			case BLOCK, EXPRESSION_STATEMENT, VARIABLE_DECLARATION,
				...
				SWITCH_CASE, RETURN_STATEMENT, THROW_STATEMENT, YIELD_STATEMENT,
				TRY_STATEMENT, CATCH_CLAUSE, FINALLY_CLAUSE,
				SYNCHRONIZED_STATEMENT, BREAK_STATEMENT, CONTINUE_STATEMENT,
				ASSERT_STATEMENT, EMPTY_STATEMENT, LABELED_STATEMENT -> WrapContext.NOT_WRAPPABLE;

			// Declarations - not wrappable
			case COMPILATION_UNIT, PACKAGE_DECLARATION, IMPORT_DECLARATION, MODULE_IMPORT_DECLARATION,
				MODULE_DECLARATION, REQUIRES_DIRECTIVE, EXPORTS_DIRECTIVE, OPENS_DIRECTIVE,
				USES_DIRECTIVE, PROVIDES_DIRECTIVE,
				CLASS_DECLARATION, INTERFACE_DECLARATION, ENUM_DECLARATION, RECORD_DECLARATION,
				ANNOTATION_DECLARATION, IMPLICIT_CLASS_DECLARATION, CONSTRUCTOR_DECLARATION, FIELD_DECLARATION,
				ENUM_CONSTANT -> WrapContext.NOT_WRAPPABLE;
