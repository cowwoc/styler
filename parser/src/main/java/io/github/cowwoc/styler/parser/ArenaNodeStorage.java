...
public class ArenaNodeStorage implements AutoCloseable {
     ...
     * @throws IllegalArgumentException if estimatedNodes is less than 1
     */
     ...
     * @param parent Parent node ID, or -1 for root
     ...
     * @return NodeInfo containing node data
     * @throws IllegalArgumentException if nodeId is invalid
     */
