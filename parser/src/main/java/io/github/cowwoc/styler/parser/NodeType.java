...
public final class NodeType
{
	 ...
	 *
	 * @param nodeType the node type byte value
	 * @return the human-readable name of the node type
	 */
		...
		return switch (nodeType)
{
	 ...
	 *
	 * @param nodeType the node type byte value
	 * @return {@code true} if the node type is a declaration, {@code false} otherwise
	 */
	public static boolean isDeclaration(byte nodeType)
{
	 ...
	 *
	 * @param nodeType the node type byte value
	 * @return {@code true} if the node type is a statement, {@code false} otherwise
	 */
	public static boolean isStatement(byte nodeType)
{
	 ...
	 *
	 * @param nodeType the node type byte value
	 * @return {@code true} if the node type is an expression, {@code false} otherwise
	 */
	public static boolean isExpression(byte nodeType)
{
	 ...
	 *
	 * @param nodeType the node type byte value
	 * @return {@code true} if the node type is a type, {@code false} otherwise
	 */
	public static boolean isType(byte nodeType)
{
	 ...
	 *
	 * @param nodeType the node type byte value
	 * @return {@code true} if the node type is a comment or whitespace, {@code false} otherwise
	 */
