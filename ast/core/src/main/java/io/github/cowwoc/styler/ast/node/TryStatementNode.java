...
/**
 * AST node representing a trystatement.
 */
public final class TryStatementNode extends ASTNode
	{
	/**
	 ...
	 */
	public TryStatementNode(SourceRange range, List<Comment> leadingComments,
	...
	@Override
	public ASTNodeBuilder<TryStatementNode> toBuilder()
		{
	...
	protected ASTNode withMetadata(SourceRange newRange, List<Comment> newLeadingComments,
		...
		Optional<ASTNode> newParent)
			{
		return new TryStatementNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent);
	}

/**
 * Builder for creating {@link TryStatementNode} instances.
 */
	public static final class Builder implements ASTNodeBuilder<TryStatementNode>
		{
		...
		public TryStatementNode build()
			...
			return new TryStatementNode(range, leadingComments, trailingComments, whitespace, hints, parent);
		}
