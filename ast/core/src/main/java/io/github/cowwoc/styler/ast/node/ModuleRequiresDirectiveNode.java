...
/**
 * AST node representing a module requires directive.
 *
 * @since 1.0
 */
public final class ModuleRequiresDirectiveNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a module requires directive node.
	 *
	 ...
	 */
	public ModuleRequiresDirectiveNode(SourceRange range, List<Comment> leadingComments,
	...
	{
		return visitor.visitModuleRequiresDirective(this, arg);
	}

	@Override
	public ASTNodeBuilder<ModuleRequiresDirectiveNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new ModuleRequiresDirectiveNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link ModuleRequiresDirectiveNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<ModuleRequiresDirectiveNode>
	{
		...
		@Override
		public ModuleRequiresDirectiveNode build()
		{
			if (!isValid())
			{
			...
			return new ModuleRequiresDirectiveNode(range, leadingComments, trailingComments, whitespace,
