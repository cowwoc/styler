...
/**
 * AST node representing a primitive pattern.
 *
 * @since 1.0
 */
public final class PrimitivePatternNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a primitive pattern node.
	 *
	 ...
	 */
	public PrimitivePatternNode(SourceRange range, List<Comment> leadingComments,
	...
	{
		return visitor.visitPrimitivePattern(this, arg);
	}

	@Override
	public ASTNodeBuilder<PrimitivePatternNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new PrimitivePatternNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link PrimitivePatternNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<PrimitivePatternNode>
	{
		...
		@Override
		public PrimitivePatternNode build()
		{
			if (!isValid())
			{
			...
			return new PrimitivePatternNode(range, leadingComments, trailingComments, whitespace,
