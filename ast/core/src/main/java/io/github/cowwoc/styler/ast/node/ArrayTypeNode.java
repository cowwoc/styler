...
/**
 * AST node representing a arraytype.
 */
public final class ArrayTypeNode extends ASTNode
	{
	/**
	 ...
	 */
	public ArrayTypeNode(SourceRange range, List<Comment> leadingComments,
	...
	@Override
	public ASTNodeBuilder<ArrayTypeNode> toBuilder()
		{
	...
	protected ASTNode withMetadata(SourceRange newRange, List<Comment> newLeadingComments,
		...
		Optional<ASTNode> newParent)
			{
		return new ArrayTypeNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent);
	}

/**
 * Builder for creating {@link ArrayTypeNode} instances.
 */
	public static final class Builder implements ASTNodeBuilder<ArrayTypeNode>
		{
		...
		public ArrayTypeNode build()
			...
			return new ArrayTypeNode(range, leadingComments, trailingComments, whitespace, hints, parent);
		}
