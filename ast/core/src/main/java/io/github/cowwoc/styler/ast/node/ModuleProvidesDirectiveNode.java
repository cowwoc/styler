...
/**
 * AST node representing a module provides directive.
 *
 * @since 1.0
 */
public final class ModuleProvidesDirectiveNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a module provides directive node.
	 *
	 ...
	 */
	public ModuleProvidesDirectiveNode(SourceRange range, List<Comment> leadingComments,
	...
	{
		return visitor.visitModuleProvidesDirective(this, arg);
	}

	@Override
	public ASTNodeBuilder<ModuleProvidesDirectiveNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new ModuleProvidesDirectiveNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link ModuleProvidesDirectiveNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<ModuleProvidesDirectiveNode>
	{
		...
		@Override
		public ModuleProvidesDirectiveNode build()
		{
			if (!isValid())
			{
			...
			return new ModuleProvidesDirectiveNode(range, leadingComments, trailingComments, whitespace,
