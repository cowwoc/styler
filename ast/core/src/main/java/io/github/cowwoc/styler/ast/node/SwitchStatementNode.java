...
/**
 * AST node representing a switchstatement.
 */
public final class SwitchStatementNode extends ASTNode
	{
	/**
	 ...
	 */
	public SwitchStatementNode(SourceRange range, List<Comment> leadingComments,
	...
	@Override
	public ASTNodeBuilder<SwitchStatementNode> toBuilder()
		{
	...
	protected ASTNode withMetadata(SourceRange newRange, List<Comment> newLeadingComments,
		...
		Optional<ASTNode> newParent)
			{
		return new SwitchStatementNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent);
	}

/**
 * Builder for creating {@link SwitchStatementNode} instances.
 */
	public static final class Builder implements ASTNodeBuilder<SwitchStatementNode>
		{
		...
		public SwitchStatementNode build()
			...
			return new SwitchStatementNode(range, leadingComments, trailingComments, whitespace, hints, parent);
		}
