...
/**
 * AST node representing a module exports directive.
 *
 * @since 1.0
 */
public final class ModuleExportsDirectiveNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a module exports directive node.
	 *
	 ...
	 */
	public ModuleExportsDirectiveNode(SourceRange range, List<Comment> leadingComments,
	...
	{
		return visitor.visitModuleExportsDirective(this, arg);
	}

	@Override
	public ASTNodeBuilder<ModuleExportsDirectiveNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new ModuleExportsDirectiveNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link ModuleExportsDirectiveNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<ModuleExportsDirectiveNode>
	{
		...
		@Override
		public ModuleExportsDirectiveNode build()
		{
			if (!isValid())
			{
			...
			return new ModuleExportsDirectiveNode(range, leadingComments, trailingComments, whitespace,
