...
/**
 * AST node representing a string template expression.
 *
 * @since 1.0
 */
public final class StringTemplateExpressionNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a string template expression node.
	 *
	 ...
	 */
	public StringTemplateExpressionNode(SourceRange range, List<Comment> leadingComments,
	...
	{
		return visitor.visitStringTemplateExpression(this, arg);
	}

	@Override
	public ASTNodeBuilder<StringTemplateExpressionNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new StringTemplateExpressionNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link StringTemplateExpressionNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<StringTemplateExpressionNode>
	{
		...
		@Override
		public StringTemplateExpressionNode build()
		{
			if (!isValid())
			{
			...
			return new StringTemplateExpressionNode(range, leadingComments, trailingComments, whitespace,
