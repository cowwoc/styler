...
/**
 * AST node representing a module uses directive.
 *
 * @since 1.0
 */
public final class ModuleUsesDirectiveNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a module uses directive node.
	 *
	 ...
	 */
	public ModuleUsesDirectiveNode(SourceRange range, List<Comment> leadingComments,
	...
	{
		return visitor.visitModuleUsesDirective(this, arg);
	}

	@Override
	public ASTNodeBuilder<ModuleUsesDirectiveNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new ModuleUsesDirectiveNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link ModuleUsesDirectiveNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<ModuleUsesDirectiveNode>
	{
		...
		@Override
		public ModuleUsesDirectiveNode build()
		{
			if (!isValid())
			{
			...
			return new ModuleUsesDirectiveNode(range, leadingComments, trailingComments, whitespace,
