...
public final class ModifierNode extends ASTNode
	 ...
	 * @param modifier the modifier keyword
	 * @throws NullPointerException if modifier is {@code null}
	 * @throws IllegalArgumentException if modifier is blank
	 */
...
/**
 * Builder for creating {@link ModifierNode} instances.
 */
	public static final class Builder implements ASTNodeBuilder<ModifierNode>
		...
		@Override public boolean isValid()
			{
			return range != null && modifier != null && !modifier.isBlank();
			}
		@Override public List<String> getValidationErrors()
			...
			if (modifier == null || modifier.isBlank())
				errors.add("modifier is required and cannot be blank");
			return errors;
			}
	}
}
