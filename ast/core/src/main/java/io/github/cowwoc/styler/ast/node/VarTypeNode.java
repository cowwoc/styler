...
/**
 * AST node representing a var type.
 *
 * @since 1.0
 */
public final class VarTypeNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a var type node.
	 *
	 ...
	 */
	public VarTypeNode(SourceRange range, List<Comment> leadingComments,
	...
	@Override
	public ASTNodeBuilder<VarTypeNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new VarTypeNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link VarTypeNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<VarTypeNode>
	{
		...
		public VarTypeNode build()
		{
			...
			return new VarTypeNode(range, leadingComments, trailingComments, whitespace,
