...
/**
 * AST node representing a yield statement.
 *
 * @since 1.0
 */
public final class YieldStatementNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a yield statement node.
	 *
	 ...
	 */
	public YieldStatementNode(SourceRange range, List<Comment> leadingComments,
	...
	@Override
	public ASTNodeBuilder<YieldStatementNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new YieldStatementNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link YieldStatementNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<YieldStatementNode>
	{
		...
		@Override
		public YieldStatementNode build()
		{
			if (!isValid())
			{
			...
			return new YieldStatementNode(range, leadingComments, trailingComments, whitespace,
