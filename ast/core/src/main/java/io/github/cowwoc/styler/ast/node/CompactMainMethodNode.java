...
/**
 * AST node representing a compact main method.
 *
 * @since 1.0
 */
public final class CompactMainMethodNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a compact main method node.
	 *
	 ...
	 */
	public CompactMainMethodNode(SourceRange range, List<Comment> leadingComments,
	...
	{
		return visitor.visitCompactMainMethod(this, arg);
	}

	@Override
	public ASTNodeBuilder<CompactMainMethodNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new CompactMainMethodNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link CompactMainMethodNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<CompactMainMethodNode>
	{
		...
		@Override
		public CompactMainMethodNode build()
		{
			if (!isValid())
			{
			...
			return new CompactMainMethodNode(range, leadingComments, trailingComments, whitespace,
