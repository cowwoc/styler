...
/**
 * AST node representing a assignment expression.
 *
 * @since 1.0
 */
public final class AssignmentExpressionNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a assignment expression node.
	 *
	 ...
	 */
	public AssignmentExpressionNode(SourceRange range, List<Comment> leadingComments,
	...
	@Override
	public ASTNodeBuilder<AssignmentExpressionNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new AssignmentExpressionNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link AssignmentExpressionNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<AssignmentExpressionNode>
	{
		...
		@Override
		public AssignmentExpressionNode build()
		{
			if (!isValid())
			{
			...
			return new AssignmentExpressionNode(range, leadingComments, trailingComments, whitespace,
