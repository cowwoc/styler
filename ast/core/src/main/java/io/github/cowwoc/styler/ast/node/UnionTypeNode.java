...
/**
 * AST node representing a union type.
 *
 * @since 1.0
 */
public final class UnionTypeNode extends ASTNode
{
	 ...
	 */
	public UnionTypeNode(SourceRange range, List<Comment> leadingComments,
	...
	@Override
	public ASTNodeBuilder<UnionTypeNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new UnionTypeNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link UnionTypeNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<UnionTypeNode>
	{
		...
		public UnionTypeNode build()
		{
			...
			return new UnionTypeNode(range, leadingComments, trailingComments, whitespace,
