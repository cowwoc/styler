...
/**
 * AST node representing a template processor expression.
 *
 * @since 1.0
 */
public final class TemplateProcessorExpressionNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a template processor expression node.
	 *
	 ...
	 */
	public TemplateProcessorExpressionNode(SourceRange range, List<Comment> leadingComments,
	...
	{
		return visitor.visitTemplateProcessorExpression(this, arg);
	}

	@Override
	public ASTNodeBuilder<TemplateProcessorExpressionNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new TemplateProcessorExpressionNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link TemplateProcessorExpressionNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<TemplateProcessorExpressionNode>
	{
		...
		@Override
		public TemplateProcessorExpressionNode build()
		{
			if (!isValid())
			{
			...
			return new TemplateProcessorExpressionNode(range, leadingComments, trailingComments, whitespace,
