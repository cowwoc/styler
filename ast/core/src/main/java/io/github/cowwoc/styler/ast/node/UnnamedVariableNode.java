...
/**
 * AST node representing a unnamed variable.
 *
 * @since 1.0
 */
public final class UnnamedVariableNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a unnamed variable node.
	 *
	 ...
	 */
	public UnnamedVariableNode(SourceRange range, List<Comment> leadingComments,
	...
	{
		return visitor.visitUnnamedVariable(this, arg);
	}

	@Override
	public ASTNodeBuilder<UnnamedVariableNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new UnnamedVariableNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link UnnamedVariableNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<UnnamedVariableNode>
	{
		...
		@Override
		public UnnamedVariableNode build()
		{
			if (!isValid())
			{
			...
			return new UnnamedVariableNode(range, leadingComments, trailingComments, whitespace,
