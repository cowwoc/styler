...
/**
 * AST node representing a enum constant.
 *
 * @since 1.0
 */
public final class EnumConstantNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a enum constant node.
	 *
	 ...
	 */
	public EnumConstantNode(SourceRange range, List<Comment> leadingComments,
	...
	{
		return visitor.visitEnumConstant(this, arg);
	}

	@Override
	public ASTNodeBuilder<EnumConstantNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new EnumConstantNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link EnumConstantNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<EnumConstantNode>
	{
		...
		public EnumConstantNode build()
		{
			...
			return new EnumConstantNode(range, leadingComments, trailingComments, whitespace,
