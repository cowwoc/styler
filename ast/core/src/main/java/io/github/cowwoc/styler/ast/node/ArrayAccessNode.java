...
/**
 * AST node representing a arrayaccess.
 */
public final class ArrayAccessNode extends ASTNode
	{
	/**
	 ...
	 */
	public ArrayAccessNode(SourceRange range, List<Comment> leadingComments,
	...
	@Override
	public ASTNodeBuilder<ArrayAccessNode> toBuilder()
		{
	...
	protected ASTNode withMetadata(SourceRange newRange, List<Comment> newLeadingComments,
		...
		Optional<ASTNode> newParent)
			{
		return new ArrayAccessNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent);
	}

/**
 * Builder for creating {@link ArrayAccessNode} instances.
 */
	public static final class Builder implements ASTNodeBuilder<ArrayAccessNode>
		{
		...
		public ArrayAccessNode build()
			...
			return new ArrayAccessNode(range, leadingComments, trailingComments, whitespace, hints, parent);
		}
