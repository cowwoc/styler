...
/**
 * AST node representing a flexible constructor body.
 *
 * @since 1.0
 */
public final class FlexibleConstructorBodyNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a flexible constructor body node.
	 *
	 ...
	 */
	public FlexibleConstructorBodyNode(SourceRange range, List<Comment> leadingComments,
	...
	{
		return visitor.visitFlexibleConstructorBody(this, arg);
	}

	@Override
	public ASTNodeBuilder<FlexibleConstructorBodyNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new FlexibleConstructorBodyNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link FlexibleConstructorBodyNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<FlexibleConstructorBodyNode>
	{
		...
		@Override
		public FlexibleConstructorBodyNode build()
		{
			if (!isValid())
			{
			...
			return new FlexibleConstructorBodyNode(range, leadingComments, trailingComments, whitespace,
