...
/**
 * AST node representing a module opens directive.
 *
 * @since 1.0
 */
public final class ModuleOpensDirectiveNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a module opens directive node.
	 *
	 ...
	 */
	public ModuleOpensDirectiveNode(SourceRange range, List<Comment> leadingComments,
	...
	{
		return visitor.visitModuleOpensDirective(this, arg);
	}

	@Override
	public ASTNodeBuilder<ModuleOpensDirectiveNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new ModuleOpensDirectiveNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link ModuleOpensDirectiveNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<ModuleOpensDirectiveNode>
	{
		...
		@Override
		public ModuleOpensDirectiveNode build()
		{
			if (!isValid())
			{
			...
			return new ModuleOpensDirectiveNode(range, leadingComments, trailingComments, whitespace,
