...
/**
 * AST node representing a annotation declaration.
 *
 * @since 1.0
 */
public final class AnnotationDeclarationNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a annotation declaration node.
	 *
	 ...
	 */
	public AnnotationDeclarationNode(SourceRange range, List<Comment> leadingComments,
	...
	{
		return visitor.visitAnnotationDeclaration(this, arg);
	}

	@Override
	public ASTNodeBuilder<AnnotationDeclarationNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new AnnotationDeclarationNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link AnnotationDeclarationNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<AnnotationDeclarationNode>
	{
		...
		@Override
		public AnnotationDeclarationNode build()
		{
			if (!isValid())
			{
			...
			return new AnnotationDeclarationNode(range, leadingComments, trailingComments, whitespace,
