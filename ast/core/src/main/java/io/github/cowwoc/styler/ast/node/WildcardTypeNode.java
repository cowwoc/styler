...
/**
 * AST node representing a wildcardtype.
 */
public final class WildcardTypeNode extends ASTNode
	{
	/**
	 * Creates a wildcard type node.
	 *
	 ...
	 */
	public WildcardTypeNode(SourceRange range, List<Comment> leadingComments,
	...
	public <R, A> R accept(ASTVisitor<R, A> visitor, A arg)
		{
		return visitor.visitWildcardType(this, arg);
	}

	@Override
	public ASTNodeBuilder<WildcardTypeNode> toBuilder()
		{
	...
	protected ASTNode withMetadata(SourceRange newRange, List<Comment> newLeadingComments,
		...
		Optional<ASTNode> newParent)
			{
		return new WildcardTypeNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent);
	}

/**
 * Builder for creating {@link WildcardTypeNode} instances.
 */
	public static final class Builder implements ASTNodeBuilder<WildcardTypeNode>
		{
		...
		public WildcardTypeNode build()
			...
			return new WildcardTypeNode(range, leadingComments, trailingComments, whitespace, hints, parent);
		}
