...
/**
 * AST node representing a booleanliteral.
 */
public final class BooleanLiteralNode extends ASTNode
	{
	/**
	 ...
	 */
	public BooleanLiteralNode(SourceRange range, List<Comment> leadingComments,
	...
	@Override
	public ASTNodeBuilder<BooleanLiteralNode> toBuilder()
		{
	...
	protected ASTNode withMetadata(SourceRange newRange, List<Comment> newLeadingComments,
		...
		Optional<ASTNode> newParent)
			{
		return new BooleanLiteralNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent);
	}

/**
 * Builder for creating {@link BooleanLiteralNode} instances.
 */
	public static final class Builder implements ASTNodeBuilder<BooleanLiteralNode>
		{
		...
		public BooleanLiteralNode build()
			...
			return new BooleanLiteralNode(range, leadingComments, trailingComments, whitespace, hints, parent);
		}
