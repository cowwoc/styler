...
/**
 * AST node representing a module import declaration.
 *
 * @since 1.0
 */
public final class ModuleImportDeclarationNode extends ASTNode
{
	 ...
	 */
	public ModuleImportDeclarationNode(SourceRange range, List<Comment> leadingComments,
	...
	{
		return visitor.visitModuleImportDeclaration(this, arg);
	}

	@Override
	public ASTNodeBuilder<ModuleImportDeclarationNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new ModuleImportDeclarationNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link ModuleImportDeclarationNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<ModuleImportDeclarationNode>
	{
		...
		@Override
		public ModuleImportDeclarationNode build()
		{
			if (!isValid())
			{
			...
			return new ModuleImportDeclarationNode(range, leadingComments, trailingComments, whitespace,
