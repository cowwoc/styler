...
/**
 * AST node representing a fieldaccess.
 */
public final class FieldAccessNode extends ASTNode
	{
	/**
	 ...
	 */
	public FieldAccessNode(SourceRange range, List<Comment> leadingComments,
	...
	@Override
	public ASTNodeBuilder<FieldAccessNode> toBuilder()
		{
	...
	protected ASTNode withMetadata(SourceRange newRange, List<Comment> newLeadingComments,
		...
		Optional<ASTNode> newParent)
			{
		return new FieldAccessNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent);
	}

/**
 * Builder for creating {@link FieldAccessNode} instances.
 */
	public static final class Builder implements ASTNodeBuilder<FieldAccessNode>
		{
		...
		public FieldAccessNode build()
			...
			return new FieldAccessNode(range, leadingComments, trailingComments, whitespace, hints, parent);
		}
