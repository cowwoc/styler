...
/**
 * AST node representing a generictype.
 */
public final class GenericTypeNode extends ASTNode
	{
	/**
	 * Creates a generic type node.
	 *
	 ...
	 */
	public GenericTypeNode(SourceRange range, List<Comment> leadingComments,
	...
	@Override
	public ASTNodeBuilder<GenericTypeNode> toBuilder()
		{
	...
	protected ASTNode withMetadata(SourceRange newRange, List<Comment> newLeadingComments,
		...
		Optional<ASTNode> newParent)
			{
		return new GenericTypeNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent);
	}

/**
 * Builder for creating {@link GenericTypeNode} instances.
 */
	public static final class Builder implements ASTNodeBuilder<GenericTypeNode>
		{
		...
		public GenericTypeNode build()
			...
			return new GenericTypeNode(range, leadingComments, trailingComments, whitespace, hints, parent);
		}
