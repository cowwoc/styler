...
/**
 * AST node representing a instance main method.
 *
 * @since 1.0
 */
public final class InstanceMainMethodNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a instance main method node.
	 *
	 ...
	 */
	public InstanceMainMethodNode(SourceRange range, List<Comment> leadingComments,
	...
	{
		return visitor.visitInstanceMainMethod(this, arg);
	}

	@Override
	public ASTNodeBuilder<InstanceMainMethodNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new InstanceMainMethodNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link InstanceMainMethodNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<InstanceMainMethodNode>
	{
		...
		@Override
		public InstanceMainMethodNode build()
		{
			if (!isValid())
			{
			...
			return new InstanceMainMethodNode(range, leadingComments, trailingComments, whitespace,
