 ...
 * @since 1.0
 */
public final class ModuleDeclarationNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a module declaration node.
	 *
	 ...
	 */
	public ModuleDeclarationNode(SourceRange range, List<Comment> leadingComments,
	...
	{
		return visitor.visitModuleDeclaration(this, arg);
	}

	@Override
	public ASTNodeBuilder<ModuleDeclarationNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new ModuleDeclarationNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link ModuleDeclarationNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<ModuleDeclarationNode>
	{
		...
		@Override
		public ModuleDeclarationNode build()
		{
			if (!isValid())
			{
			...
			return new ModuleDeclarationNode(range, leadingComments, trailingComments, whitespace,
