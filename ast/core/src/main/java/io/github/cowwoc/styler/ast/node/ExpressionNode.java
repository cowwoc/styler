...
/**
 * AST node representing a expression.
 *
 * @since 1.0
 */
public final class ExpressionNode extends ASTNode
{
	 ...
	 */
	public ExpressionNode(SourceRange range, List<Comment> leadingComments,
	...
	@Override
	public ASTNodeBuilder<ExpressionNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new ExpressionNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link ExpressionNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<ExpressionNode>
	{
		...
		public ExpressionNode build()
		{
			...
			return new ExpressionNode(range, leadingComments, trailingComments, whitespace,
