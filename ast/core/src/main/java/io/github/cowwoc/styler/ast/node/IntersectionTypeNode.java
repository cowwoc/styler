...
/**
 * AST node representing a intersection type.
 *
 * @since 1.0
 */
public final class IntersectionTypeNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a intersection type node.
	 *
	 ...
	 */
	public IntersectionTypeNode(SourceRange range, List<Comment> leadingComments,
	...
	@Override
	public ASTNodeBuilder<IntersectionTypeNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new IntersectionTypeNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link IntersectionTypeNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<IntersectionTypeNode>
	{
		...
		@Override
		public IntersectionTypeNode build()
		{
			if (!isValid())
			{
			...
			return new IntersectionTypeNode(range, leadingComments, trailingComments, whitespace,
