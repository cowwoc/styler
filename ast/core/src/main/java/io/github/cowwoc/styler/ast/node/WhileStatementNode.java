...
/**
 * AST node representing a whilestatement.
 */
public final class WhileStatementNode extends ASTNode
	{
	/**
	 ...
	 */
	public WhileStatementNode(SourceRange range, List<Comment> leadingComments,
	...
	@Override
	public ASTNodeBuilder<WhileStatementNode> toBuilder()
		{
	...
	protected ASTNode withMetadata(SourceRange newRange, List<Comment> newLeadingComments,
		...
		Optional<ASTNode> newParent)
			{
		return new WhileStatementNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent);
	}

/**
 * Builder for creating {@link WhileStatementNode} instances.
 */
	public static final class Builder implements ASTNodeBuilder<WhileStatementNode>
		{
		...
		public WhileStatementNode build()
			...
			return new WhileStatementNode(range, leadingComments, trailingComments, whitespace, hints, parent);
		}
