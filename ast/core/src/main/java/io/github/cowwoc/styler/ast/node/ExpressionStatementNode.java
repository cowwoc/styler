...
public final class ExpressionStatementNode extends ASTNode {
	...
	public static final class Builder implements ASTNodeBuilder<ExpressionStatementNode> {
		...
		public Builder setExpression(ASTNode expression) { this.expression = expression; return this; }
		...
		public ExpressionStatementNode build() {
			...
			return new ExpressionStatementNode(range, leadingComments, trailingComments, whitespace, hints, parent, expression);
		}

		@Override public Builder reset() { range = null; leadingComments = List.of(); trailingComments = List.of(); whitespace = WhitespaceInfo.none(); hints = FormattingHints.defaults(); parent = Optional.empty(); expression = null; return this; }
		...
		@Override public boolean isValid() { return range != null && expression != null; }
		@Override public List<String> getValidationErrors() { var errors = new java.util.ArrayList<String>(); if (range == null) errors.add("range is required"); if (expression == null) errors.add("expression final is required"); return errors; }
	}
}
