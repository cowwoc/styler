...
/**
 * AST node representing a methodcall.
 */
public final class MethodCallNode extends ASTNode
	{
	/**
	 ...
	 */
	public MethodCallNode(SourceRange range, List<Comment> leadingComments,
	...
	@Override
	public ASTNodeBuilder<MethodCallNode> toBuilder()
		{
	...
	protected ASTNode withMetadata(SourceRange newRange, List<Comment> newLeadingComments,
		...
		Optional<ASTNode> newParent)
			{
		return new MethodCallNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent);
	}

/**
 * Builder for creating {@link MethodCallNode} instances.
 */
	public static final class Builder implements ASTNodeBuilder<MethodCallNode>
		{
		...
		public MethodCallNode build()
			...
			return new MethodCallNode(range, leadingComments, trailingComments, whitespace, hints, parent);
		}
