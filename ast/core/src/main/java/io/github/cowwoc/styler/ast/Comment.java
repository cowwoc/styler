...
public record Comment(Type type, String content, SourcePosition position, boolean preserveFormatting) {
	...
	public enum Type {
		...
		BLOCK,
		/** Javadoc comment starting with Javadoc delimiters */
		JAVADOC
	}
	 ...
	 * @param content the comment text (without // prefix)
	 * @param position the source position
	 * @return a new line Comment
	 */
	 ...
	 * @return a new Comment with preserveFormatting set to true
	 */
