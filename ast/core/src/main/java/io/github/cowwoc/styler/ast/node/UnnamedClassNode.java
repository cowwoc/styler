...
/**
 * AST node representing a unnamed class.
 *
 * @since 1.0
 */
public final class UnnamedClassNode extends ASTNode
{
	private final List<ASTNode> children;

	/**
	 * Creates a unnamed class node.
	 *
	 ...
	 */
	public UnnamedClassNode(SourceRange range, List<Comment> leadingComments,
	...
	{
		return visitor.visitUnnamedClass(this, arg);
	}

	@Override
	public ASTNodeBuilder<UnnamedClassNode> toBuilder()
	{
		return new Builder().
			setRange(getRange()).
	...
	{
		return new UnnamedClassNode(newRange, newLeadingComments, newTrailingComments,
			newWhitespace, newHints, newParent, children);
	}

	/**
	 * Builder for creating {@link UnnamedClassNode} instances.
	 */
	public static final class Builder implements ASTNodeBuilder<UnnamedClassNode>
	{
		...
		public UnnamedClassNode build()
		{
			...
			return new UnnamedClassNode(range, leadingComments, trailingComments, whitespace,
