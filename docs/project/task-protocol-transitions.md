...
**WHEN TO READ**: When transitioning between specific states or debugging state issues.

**RECOMMENDED**: Use the `state-transition` skill for common transitions instead of reading this document.
